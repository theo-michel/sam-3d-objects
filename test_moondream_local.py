...
def visualize_results(
    image_path: str, results: list[dict], save_dir: str = "output_moondream"
):
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Test Moondream segmentation with a local image."
    )
    parser.add_argument("image_path", type=str, help="Path to the local image file")
    parser.add_argument(
        "--prompt", type=str, default="Points of interest", help="Prompt for Moondream"
    )
